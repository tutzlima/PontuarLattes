...
q13 <- read.delim("PontuarLattes/qualis/classificacoes_publicadas_todas_as_areas_avaliacao1522078273541.xls",
...
save(q13, file = "PontuarLattes/auxiliar/qualis_2013_2016.RData")
